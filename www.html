...
<body>
    ...
    <p>
        ...
        <a href="#">hypermedia</a> information retrieval initiative aiming to give universal access to a large universe of documents.
    </p>

    <p>
        Everything there is online about W3 is linked directly or indirectly to this document, including an 
        <a href="#">executive summary</a> of the project,
    ...
    <p>
        <a href="#">How can I help ?</a><br>
        If you would like to support the web..
    </p>

    <p>
        <a href="#">Getting code</a><br>
        Getting the code by 
        <a href="#">anonymous FTP</a>, etc.
    </p>
